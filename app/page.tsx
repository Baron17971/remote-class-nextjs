...
export default function App() {
  ...
  const generateFullPlanAI = async () => {
    ...
    const promptText = `אתה מומחה פדגוגי. בנה מערך שיעור סינכרוני מלא לפי מודל חז"ק.
      ...
      חובה עבור שלב ה"חריש": הצע פעילויות מעוררות סקרנות המבוססות על ויזואליה וכלים מתקדמים. לדוגמה: הצגת תמונה או אינפוגרפיקה ושאילת שאלות עליה, חידות מסקרנות, או שימוש ב-Gemini/NotebookLM ליצירת תוכן ויזואלי/טקסטואלי שמגרה את המחשבה.
      ...
      ${advancedOptions.useAITools ? "חובה עליך לשלב בהצעות כלי פיצוח טכנולוגיים מתקדמים מאוד כגון Gemini, NotebookLM, מחוללי תמונות, Canva AI ופלטפורמות משחוק. תן עדיפות עליונה לכלים אלו." : "שלב רעיונות יצירתיים יחד עם כלים טכנולוגיים מתאימים."}
  ...
  const generatePhaseAI = async (phaseId: string) => {
    ...
    const promptText = `אתה מומחה פדגוגי. הצע 3 אפשרויות שונות ומגוונות לשלב ה"${phaseConfig.title}" במערך שיעור סינכרוני.
      ...
      ${contextAddition}
      ${phaseId === 'harish' ? 'דגש מיוחד לשלב ה"חריש": הצע פעילויות ויזואליות ומעוררות סקרנות. לדוגמה: הצגת תמונה או אינפוגרפיקה ושאילת שאלות עליה, חידות מסקרנות, או שימוש בכלים כמו Gemini ו-NotebookLM ליצירת תוכן חכם.' : ''}
      ...
      ${advancedOptions.useAITools ? "חובה עליך לשלב בהצעות כלי פיצוח טכנולוגיים מתקדמים מאוד כגון Gemini, NotebookLM, מחוללי תמונות, Canva AI ופלטפורמות משחוק." : "שלב רעיונות יצירתיים יחד עם כלים טכנולוגיים מתאימים."}
