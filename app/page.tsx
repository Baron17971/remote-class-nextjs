...
const SUBJECTS = [
  ...
  'אמנות', 'מוזיקה', 'חינוך/כישורי חיים', 'אחר'
];
...
export default function App() {
  ...
  const generateFullPlanAI = async () => {
    ...
    const promptText = `אתה מומחה פדגוגי. בנה מערך שיעור סינכרוני מלא לפי מודל חז"ק.
      ...
      ${advancedOptions.useAITools ? "חובה עליך לשלב בהצעות כלי פיצוח טכנולוגיים מתקדמים מאוד כגון Gemini, מחוללי תמונות (Midjourney/DALL-E), סביבות Canva AI ופלטפורמות משחוק פורצות דרך. תן עדיפות עליונה לכלים אלו על פני כלים בסיסיים והסבר בקצרה על הערך הפדגוגי שלהם." : "שלב רעיונות יצירתיים יחד עם כלים טכנולוגיים מתאימים."}
